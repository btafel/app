...
i18n.translations = {
  ...
  it: { 
      slide1: 'CoTrack deve conoscere la tua posizione per avvisarti in tempo reale se durante il tour eri in stretto contatto con una persona infetta',
      slide2: 'Se hai sintomi o pensi di essere stato in contatto con qualcuno infetto, CoTrack può aiutarti a effettuare una valutazione e consigliarti cosa fare in base al risultato',
      slide3: 'CoTrack fornisce informazioni complete e affidabili per aiutare a prevenire le infezioni, misure per proteggersi e informazioni utili e aggiornate',
      Next: 'Seguente',
      Prev: 'Anterior',
      Done: 'Finalizza',
  },
